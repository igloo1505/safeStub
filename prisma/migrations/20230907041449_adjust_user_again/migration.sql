...
CREATE TABLE "users" (
    ...
    "IdVerified" "VERIFICATIONSTATUS" NOT NULL DEFAULT 'Unverified',
...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "users_paymentAccountDetailsId_fkey" FOREIGN KEY ("paymentAccountDetailsId") REFERENCES "PaymentAccountDetails"("id") ON DELETE SET NULL ON UPDATE CASCADE;
