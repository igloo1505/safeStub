...
export const PurchaseHistoryFindManySchema = Yup.object({ where: PurchaseHistoryWhereInputObjectSchema, orderBy: PurchaseHistoryOrderByWithRelationInputObjectSchema, cursor: PurchaseHistoryWhereUniqueInputObjectSchema, take: Yup.number(), skip: Yup.number(), distinct: Yup.array().of(PurchaseHistoryScalarFieldEnumSchema)  }).required()