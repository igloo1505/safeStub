...
import { EventUncheckedUpdateManyWithoutAmenitiesNestedInputObjectSchema } from '../internals';

export const ArenaAmenitiesUncheckedUpdateInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  Arena: ArenaUncheckedUpdateManyWithoutAmenitiesNestedInputObjectSchema,  Event: EventUncheckedUpdateManyWithoutAmenitiesNestedInputObjectSchema
});
