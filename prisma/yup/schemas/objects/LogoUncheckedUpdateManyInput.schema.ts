...
export const LogoUncheckedUpdateManyInputObjectSchema = Yup.object({
...
NullableStringFieldUpdateOperationsInputObjectSchema]),  teamId: Yup.mixed().oneOfSchemas([Yup.number(),
