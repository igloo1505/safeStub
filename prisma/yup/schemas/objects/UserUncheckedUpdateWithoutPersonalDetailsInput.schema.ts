...
export const UserUncheckedUpdateWithoutPersonalDetailsInputObjectSchema = Yup.object({
...
NullableIntFieldUpdateOperationsInputObjectSchema]),  verified: Yup.mixed().oneOfSchemas([EnumVERIFICATIONSTATUSFieldUpdateOperationsInputObjectSchema]),  purchaseHistory: PurchaseHistoryUncheckedUpdateOneWithoutUserNestedInputObjectSchema
});
