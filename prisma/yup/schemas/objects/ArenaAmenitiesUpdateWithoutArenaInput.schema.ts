...
export const ArenaAmenitiesUpdateWithoutArenaInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  Event: EventUpdateManyWithoutAmenitiesNestedInputObjectSchema
});
