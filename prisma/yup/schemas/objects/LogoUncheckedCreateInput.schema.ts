...
export const LogoUncheckedCreateInputObjectSchema = Yup.object({
...
Yup.array().of(Yup.string())]),  url: Yup.mixed().oneOfSchemas([Yup.string()]),  teamId: Yup.mixed().oneOfSchemas([Yup.number()])
});
