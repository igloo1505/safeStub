...
export const EventUncheckedUpdateWithoutTagsInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  tickets: TicketUncheckedUpdateManyWithoutEventNestedInputObjectSchema,  ticketGroups: TicketGroupUncheckedUpdateManyWithoutEventNestedInputObjectSchema,  participants: TeamUncheckedUpdateManyWithoutEventNestedInputObjectSchema
});
