...
NestedFloatNullableWithAggregatesFilterObjectSchema]),  _count: NestedIntNullableFilterObjectSchema,  _avg: NestedFloatNullableFilterObjectSchema,  _sum: NestedFloatNullableFilterObjectSchema,  _min: NestedFloatNullableFilterObjectSchema,  _max: NestedFloatNullableFilterObjectSchema
});
