...
import { ArenaUpdateManyWithoutLocationNestedInputObjectSchema } from '../internals';;
...
NullableFloatFieldUpdateOperationsInputObjectSchema]),  country: Yup.mixed().oneOfSchemas([EnumCountryFieldUpdateOperationsInputObjectSchema]),  arena: ArenaUpdateManyWithoutLocationNestedInputObjectSchema,  personalDetails: PersonalDetailsUpdateOneWithoutLocationNestedInputObjectSchema
});
