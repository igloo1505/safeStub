...
StringFieldUpdateOperationsInputObjectSchema]),  date: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  seller: PurchaseHistoryUpdateOneRequiredWithoutSoldNestedInputObjectSchema,  buyer: PurchaseHistoryUpdateOneRequiredWithoutBoughtNestedInputObjectSchema
});
