...
export const ArenaAmenitiesUncheckedUpdateWithoutArenaInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  Event: EventUncheckedUpdateManyWithoutAmenitiesNestedInputObjectSchema
});
