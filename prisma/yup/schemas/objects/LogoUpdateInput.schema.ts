...
import { TeamUpdateOneWithoutLogosNestedInputObjectSchema } from '../internals';

export const LogoUpdateInputObjectSchema = Yup.object({
...
NullableStringFieldUpdateOperationsInputObjectSchema]),  Team: TeamUpdateOneWithoutLogosNestedInputObjectSchema
});
