...
export const TransactionUncheckedUpdateManyWithoutSoldInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  buyerId: Yup.mixed().oneOfSchemas([Yup.number(),
