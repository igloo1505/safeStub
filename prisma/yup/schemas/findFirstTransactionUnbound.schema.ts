...
export const TransactionUnboundFindFirstSchema = Yup.object({ where: TransactionUnboundWhereInputObjectSchema, orderBy: TransactionUnboundOrderByWithRelationInputObjectSchema, cursor: TransactionUnboundWhereUniqueInputObjectSchema, take: Yup.number(), skip: Yup.number(), distinct: Yup.array().of(TransactionUnboundScalarFieldEnumSchema) }).required()