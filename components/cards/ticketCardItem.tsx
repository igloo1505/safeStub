...
const TicketCardItem = ({ ticket, useScreen }: TicketCardItemProps) => {
    return (
        <div className={clsx("w-full h-fit flex flex-col justify-start items-start gap-2 border border-border px-3 py-2", useScreen ? "xxs:grid xxs:grid-cols-[1fr_1fr_1fr] xxs:gap-4 min-w-[min(250px,90vw)]" : "@[250px]:grid @[250px]:grid-cols-[1fr_1fr_1fr] @[250px]:gap-4")}>
