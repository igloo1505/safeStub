...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutPaymentAccountNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedUpdateManyWithoutPaymentAccountNestedInputObjectSchema =
  Schema;
