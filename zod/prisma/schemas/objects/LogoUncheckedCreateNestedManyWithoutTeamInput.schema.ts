...
const Schema: z.ZodType<Prisma.LogoUncheckedCreateNestedManyWithoutTeamInput> =
  z
    .object({
      create: z
        .union([
...
export const LogoUncheckedCreateNestedManyWithoutTeamInputObjectSchema = Schema;
