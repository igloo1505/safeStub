...
const Schema: z.ZodType<Prisma.TicketUncheckedCreateNestedManyWithoutArenaSectionInput> =
  z
    .object({
      create: z
        .union([
...
export const TicketUncheckedCreateNestedManyWithoutArenaSectionInputObjectSchema =
  Schema;
