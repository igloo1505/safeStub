...
const Schema: z.ZodType<Prisma.TicketUncheckedUpdateManyWithoutTicketGroupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TicketUncheckedUpdateManyWithoutTicketGroupNestedInputObjectSchema =
  Schema;
