...
const Schema: z.ZodType<Prisma.TransactionUncheckedUpdateManyWithoutBoughtInput> =
  z
    .object({
      id: z
        .union([
...
export const TransactionUncheckedUpdateManyWithoutBoughtInputObjectSchema =
  Schema;
