...
const Schema: z.ZodType<Prisma.TransactionUncheckedUpdateManyWithoutSellerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TransactionUncheckedUpdateManyWithoutSellerNestedInputObjectSchema =
  Schema;
