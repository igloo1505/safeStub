...
const Schema: z.ZodType<Prisma.EventUncheckedCreateNestedManyWithoutArenaInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => EventUncheckedCreateWithoutArenaInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => EventCreateOrConnectWithoutArenaInputObjectSchema)
            .array(),
        ])
        .optional(),
      createMany: z
...
export const EventUncheckedCreateNestedManyWithoutArenaInputObjectSchema =
  Schema;
