...
const Schema: z.ZodType<Prisma.TicketUncheckedUpdateManyWithoutArenaSectionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TicketUncheckedUpdateManyWithoutArenaSectionNestedInputObjectSchema =
  Schema;
