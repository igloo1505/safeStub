...
const Schema: z.ZodType<Prisma.ArenaSectionUncheckedUpdateManyWithoutArenaNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ArenaSectionUncheckedUpdateManyWithoutArenaNestedInputObjectSchema =
  Schema;
