...
const Schema: z.ZodType<Prisma.ArenaSectionUncheckedCreateNestedManyWithoutArenaInput> =
  z
    .object({
      create: z
        .union([
...
export const ArenaSectionUncheckedCreateNestedManyWithoutArenaInputObjectSchema =
  Schema;
