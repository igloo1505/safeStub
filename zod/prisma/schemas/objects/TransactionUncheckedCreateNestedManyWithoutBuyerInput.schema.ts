...
const Schema: z.ZodType<Prisma.TransactionUncheckedCreateNestedManyWithoutBuyerInput> =
  z
    .object({
      create: z
        .union([
...
export const TransactionUncheckedCreateNestedManyWithoutBuyerInputObjectSchema =
  Schema;
