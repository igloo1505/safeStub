...
const Schema: z.ZodType<Prisma.ArenaSectionUncheckedUpdateWithoutArenaInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const ArenaSectionUncheckedUpdateWithoutArenaInputObjectSchema = Schema;
