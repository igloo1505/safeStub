...
const Schema: z.ZodType<Prisma.TeamUncheckedCreateNestedManyWithoutEventInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => TeamUncheckedCreateWithoutEventInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => TeamCreateOrConnectWithoutEventInputObjectSchema)
            .array(),
        ])
        .optional(),
      connect: z
...
export const TeamUncheckedCreateNestedManyWithoutEventInputObjectSchema =
  Schema;
