...
const Schema: z.ZodType<Prisma.ArenaUpdateManyWithWhereWithoutSectionImageInput> =
  z
    .object({
...
export const ArenaUpdateManyWithWhereWithoutSectionImageInputObjectSchema =
  Schema;
