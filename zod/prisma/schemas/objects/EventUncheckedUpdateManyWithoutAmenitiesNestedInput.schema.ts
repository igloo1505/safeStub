...
const Schema: z.ZodType<Prisma.EventUncheckedUpdateManyWithoutAmenitiesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => EventUpdateManyWithWhereWithoutAmenitiesInputObjectSchema,
          ),
          z
            .lazy(
              () => EventUpdateManyWithWhereWithoutAmenitiesInputObjectSchema,
...
export const EventUncheckedUpdateManyWithoutAmenitiesNestedInputObjectSchema =
  Schema;
