...
const Schema: z.ZodType<Prisma.TicketGroupUncheckedCreateNestedManyWithoutEventInput> =
  z
    .object({
      create: z
        .union([
...
export const TicketGroupUncheckedCreateNestedManyWithoutEventInputObjectSchema =
  Schema;
