...
const Schema: z.ZodType<Prisma.TeamUncheckedCreateNestedManyWithoutHomeArenaInput> =
  z
    .object({
      create: z
        .union([
...
export const TeamUncheckedCreateNestedManyWithoutHomeArenaInputObjectSchema =
  Schema;
