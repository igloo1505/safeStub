...
const Schema: z.ZodType<Prisma.LegalNameUpdateOneWithoutPersonalDetailsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const LegalNameUpdateOneWithoutPersonalDetailsNestedInputObjectSchema =
  Schema;
