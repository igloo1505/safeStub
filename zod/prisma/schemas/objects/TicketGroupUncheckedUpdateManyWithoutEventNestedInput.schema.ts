...
const Schema: z.ZodType<Prisma.TicketGroupUncheckedUpdateManyWithoutEventNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TicketGroupUncheckedUpdateManyWithoutEventNestedInputObjectSchema =
  Schema;
