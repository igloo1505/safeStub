...
const Schema: z.ZodType<Prisma.ArenaUpdateManyWithoutLocationNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ArenaUpdateManyWithWhereWithoutLocationInputObjectSchema),
        z
          .lazy(() => ArenaUpdateManyWithWhereWithoutLocationInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ArenaUpdateManyWithoutLocationNestedInputObjectSchema = Schema;
