...
const Schema: z.ZodType<Prisma.PersonalDetailsUncheckedCreateNestedOneWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const PersonalDetailsUncheckedCreateNestedOneWithoutUserInputObjectSchema =
  Schema;
