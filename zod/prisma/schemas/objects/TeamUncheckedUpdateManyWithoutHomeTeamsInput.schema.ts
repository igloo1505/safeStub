...
const Schema: z.ZodType<Prisma.TeamUncheckedUpdateManyWithoutHomeTeamsInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const TeamUncheckedUpdateManyWithoutHomeTeamsInputObjectSchema = Schema;
