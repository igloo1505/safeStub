...
const Schema: z.ZodType<Prisma.NestedEnumVERIFICATIONSTATUSWithAggregatesFilter> =
  z
    .object({
...
export const NestedEnumVERIFICATIONSTATUSWithAggregatesFilterObjectSchema =
  Schema;
