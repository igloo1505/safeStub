...
const Schema: z.ZodType<Prisma.SettingsUncheckedCreateNestedOneWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const SettingsUncheckedCreateNestedOneWithoutUserInputObjectSchema =
  Schema;
