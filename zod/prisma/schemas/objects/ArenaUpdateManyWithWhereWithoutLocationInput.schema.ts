...
const Schema: z.ZodType<Prisma.ArenaUpdateManyWithWhereWithoutLocationInput> = z
  .object({
...
export const ArenaUpdateManyWithWhereWithoutLocationInputObjectSchema = Schema;
