...
const Schema: z.ZodType<Prisma.TransactionCreateNestedManyWithoutSellerInput> =
  z
    .object({
      create: z
        .union([
...
export const TransactionCreateNestedManyWithoutSellerInputObjectSchema = Schema;
