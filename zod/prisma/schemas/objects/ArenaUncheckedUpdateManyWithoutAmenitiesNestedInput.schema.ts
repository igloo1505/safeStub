...
const Schema: z.ZodType<Prisma.ArenaUncheckedUpdateManyWithoutAmenitiesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ArenaUpdateManyWithWhereWithoutAmenitiesInputObjectSchema,
          ),
          z
            .lazy(
              () => ArenaUpdateManyWithWhereWithoutAmenitiesInputObjectSchema,
...
export const ArenaUncheckedUpdateManyWithoutAmenitiesNestedInputObjectSchema =
  Schema;
