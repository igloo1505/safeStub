...
const Schema: z.ZodType<Prisma.TeamUpdateManyWithoutHomeArenaNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => TeamUpdateManyWithWhereWithoutHomeArenaInputObjectSchema),
        z
          .lazy(() => TeamUpdateManyWithWhereWithoutHomeArenaInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const TeamUpdateManyWithoutHomeArenaNestedInputObjectSchema = Schema;
