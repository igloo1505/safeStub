...
const Schema: z.ZodType<Prisma.LocationCreateNestedOneWithoutPersonalDetailsInput> =
  z
    .object({
      create: z
        .union([
...
export const LocationCreateNestedOneWithoutPersonalDetailsInputObjectSchema =
  Schema;
