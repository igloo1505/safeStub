...
import { ArenaUncheckedUpdateManyWithoutLocationNestedInputObjectSchema } from './ArenaUncheckedUpdateManyWithoutLocationNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.LocationUncheckedUpdateWithoutPersonalDetailsInput> =
  z
    .object({
      id: z
        .union([
      ...
      state: z
        .union([
          ...
          z.lazy(
            () => NullableEnumUSSTATEFieldUpdateOperationsInputObjectSchema,
          ),
        ])
        .optional()
        .nullable(),
      ...
      arena: z
        .lazy(
          () => ArenaUncheckedUpdateManyWithoutLocationNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const LocationUncheckedUpdateWithoutPersonalDetailsInputObjectSchema =
  Schema;
