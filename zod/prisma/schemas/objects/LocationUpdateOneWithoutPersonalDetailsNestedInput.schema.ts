...
const Schema: z.ZodType<Prisma.LocationUpdateOneWithoutPersonalDetailsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const LocationUpdateOneWithoutPersonalDetailsNestedInputObjectSchema =
  Schema;
