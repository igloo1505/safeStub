...
import { NestedEnumNFL_ConferenceNullableWithAggregatesFilterObjectSchema } from './NestedEnumNFL_ConferenceNullableWithAggregatesFilter.schema';
...
const Schema: z.ZodType<Prisma.EnumNFL_ConferenceNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const EnumNFL_ConferenceNullableWithAggregatesFilterObjectSchema =
  Schema;
