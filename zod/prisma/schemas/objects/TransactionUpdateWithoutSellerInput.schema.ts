...
import { PurchaseHistoryUpdateOneWithoutBoughtNestedInputObjectSchema } from './PurchaseHistoryUpdateOneWithoutBoughtNestedInput.schema';
...
const Schema: z.ZodType<Prisma.TransactionUpdateWithoutSellerInput> = z
  .object({
    ...
    purchasedOn: z
      ...
      .nullable(),
    buyer: z
      .lazy(() => PurchaseHistoryUpdateOneWithoutBoughtNestedInputObjectSchema)
      .optional(),
    tickets: z
