...
const Schema: z.ZodType<Prisma.TransactionUncheckedUpdateWithoutBuyerInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const TransactionUncheckedUpdateWithoutBuyerInputObjectSchema = Schema;
