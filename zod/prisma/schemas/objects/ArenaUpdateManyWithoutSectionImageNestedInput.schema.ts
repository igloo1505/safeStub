...
const Schema: z.ZodType<Prisma.ArenaUpdateManyWithoutSectionImageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ArenaUpdateManyWithoutSectionImageNestedInputObjectSchema = Schema;
