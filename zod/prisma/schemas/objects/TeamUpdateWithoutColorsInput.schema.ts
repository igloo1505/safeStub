...
import { ArenaUpdateOneWithoutHomeTeamsNestedInputObjectSchema } from './ArenaUpdateOneWithoutHomeTeamsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.TeamUpdateWithoutColorsInput> = z
  .object({
    uniqueKey: z
      .union([
        z.string(),
    ...
    division: z
      ...
      .nullable(),
    homeArena: z
      .lazy(() => ArenaUpdateOneWithoutHomeTeamsNestedInputObjectSchema)
      .optional(),
    Event: z
...
export const TeamUpdateWithoutColorsInputObjectSchema = Schema;
