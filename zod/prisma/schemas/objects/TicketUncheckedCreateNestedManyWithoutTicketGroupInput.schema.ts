...
const Schema: z.ZodType<Prisma.TicketUncheckedCreateNestedManyWithoutTicketGroupInput> =
  z
    .object({
      create: z
        .union([
...
export const TicketUncheckedCreateNestedManyWithoutTicketGroupInputObjectSchema =
  Schema;
