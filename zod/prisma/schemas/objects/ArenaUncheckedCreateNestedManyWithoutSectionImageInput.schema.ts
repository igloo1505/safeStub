...
const Schema: z.ZodType<Prisma.ArenaUncheckedCreateNestedManyWithoutSectionImageInput> =
  z
    .object({
      create: z
        .union([
...
export const ArenaUncheckedCreateNestedManyWithoutSectionImageInputObjectSchema =
  Schema;
