...
const Schema: z.ZodType<Prisma.LegalNameCreateNestedOneWithoutPersonalDetailsInput> =
  z
    .object({
      create: z
        .union([
...
export const LegalNameCreateNestedOneWithoutPersonalDetailsInputObjectSchema =
  Schema;
