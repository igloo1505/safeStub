...
const Schema: z.ZodType<Prisma.PurchaseHistoryUncheckedCreateNestedOneWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const PurchaseHistoryUncheckedCreateNestedOneWithoutUserInputObjectSchema =
  Schema;
