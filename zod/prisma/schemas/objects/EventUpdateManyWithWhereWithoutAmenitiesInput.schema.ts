...
const Schema: z.ZodType<Prisma.EventUpdateManyWithWhereWithoutAmenitiesInput> =
  z
    .object({
...
export const EventUpdateManyWithWhereWithoutAmenitiesInputObjectSchema = Schema;
