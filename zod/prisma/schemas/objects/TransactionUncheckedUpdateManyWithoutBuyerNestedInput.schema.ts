...
const Schema: z.ZodType<Prisma.TransactionUncheckedUpdateManyWithoutBuyerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TransactionUncheckedUpdateManyWithoutBuyerNestedInputObjectSchema =
  Schema;
