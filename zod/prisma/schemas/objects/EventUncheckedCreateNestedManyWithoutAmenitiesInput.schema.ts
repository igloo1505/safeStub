...
const Schema: z.ZodType<Prisma.EventUncheckedCreateNestedManyWithoutAmenitiesInput> =
  z
    .object({
      create: z
        .union([
...
export const EventUncheckedCreateNestedManyWithoutAmenitiesInputObjectSchema =
  Schema;
