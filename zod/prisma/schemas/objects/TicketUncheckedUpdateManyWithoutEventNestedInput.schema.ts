...
const Schema: z.ZodType<Prisma.TicketUncheckedUpdateManyWithoutEventNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => TicketUpsertWithWhereUniqueWithoutEventInputObjectSchema,
          ),
          z
            .lazy(
              () => TicketUpsertWithWhereUniqueWithoutEventInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => TicketUpdateWithWhereUniqueWithoutEventInputObjectSchema,
          ),
          z
            .lazy(
              () => TicketUpdateWithWhereUniqueWithoutEventInputObjectSchema,
...
export const TicketUncheckedUpdateManyWithoutEventNestedInputObjectSchema =
  Schema;
