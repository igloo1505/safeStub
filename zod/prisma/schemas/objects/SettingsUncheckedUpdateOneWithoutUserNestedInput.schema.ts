...
const Schema: z.ZodType<Prisma.SettingsUncheckedUpdateOneWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => SettingsUpsertWithoutUserInputObjectSchema)
        .optional(),
...
export const SettingsUncheckedUpdateOneWithoutUserNestedInputObjectSchema =
  Schema;
